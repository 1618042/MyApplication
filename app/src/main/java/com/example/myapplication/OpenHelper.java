...
public class OpenHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES = "CREATE TABLE "+ TABLE_NAME + " (" + _ID + " INTEGER PRIMARY KEY," + time + " time," +  x_axis + " x_axis," + y_axis + " y_axis," + z_axis + " z_axis," + latitude + " latitude," + longitude + " longitude)";
